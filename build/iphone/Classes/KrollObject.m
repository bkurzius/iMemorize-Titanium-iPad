...
//@interface iMemorizeiPadJune2011Object : NSObject
//@end

@interface iMemorizeiPadJune2011Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[iMemorizeiPadJune2011Object class]])
		{
			for (NSString *key in [[(iMemorizeiPadJune2011Object*)o modules] allKeys])
			{
