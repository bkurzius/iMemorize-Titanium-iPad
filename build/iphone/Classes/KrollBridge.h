...
@interface iMemorizeiPadJune2011Object : KrollCoverageObject {
#else
@interface iMemorizeiPadJune2011Object : KrollObject {
#endif
@private
...
extern NSString * iMemorizeiPadJune2011$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	iMemorizeiPadJune2011Object *_imemorizeipadjune2011;
    KrollObject* console;
	BOOL shutdown;
