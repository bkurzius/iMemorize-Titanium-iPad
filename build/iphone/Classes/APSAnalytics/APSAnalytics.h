 ...
 * to send analytic data that can be viewed on the iMemorizeiPadJune2011 Dashboard.
 *
 * For information on getting started with iMemorizeiPadJune2011 Platform Services,
