...
//Rare exceptions to indicate a bug in the _imemorizeipadjune2011 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for iMemorizeiPadJune2011 proxies.
 */
