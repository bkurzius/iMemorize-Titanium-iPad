...
/**
 Base class for all iMemorizeiPadJune2011 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the iMemorizeiPadJune2011 view hierarchy (such as wrapped iOS UIViews) was touched.
