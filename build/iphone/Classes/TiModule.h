...
/**
 The base class for all iMemorizeiPadJune2011 modules
 */
...
/**
 iMemorizeiPadJune2011 Platform calls this method on startup.
 */
-(void)startup;

/**
 iMemorizeiPadJune2011 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 iMemorizeiPadJune2011 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 iMemorizeiPadJune2011 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 iMemorizeiPadJune2011 Platform calls this method on resume.
 @param sender The sender of the event.
 */
