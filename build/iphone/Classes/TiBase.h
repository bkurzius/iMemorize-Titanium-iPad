...
// in simulator we redefine to format for iMemorizeiPadJune2011 Developer console
...
{\
	NSString * exceptionName = [@"org.imemorizeipadjune2011." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.imemorizeipadjune2011";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIiMemorizeiPadJune2011NativeItemNone = -1, 
	UIiMemorizeiPadJune2011NativeItemSpinner = -2,
	UIiMemorizeiPadJune2011NativeItemProgressBar = -3,
	
	UIiMemorizeiPadJune2011NativeItemSlider = -4,
	UIiMemorizeiPadJune2011NativeItemSwitch = -5,
	UIiMemorizeiPadJune2011NativeItemMultiButton = -6,
	UIiMemorizeiPadJune2011NativeItemSegmented = -7,
	
	UIiMemorizeiPadJune2011NativeItemTextView = -8,
	UIiMemorizeiPadJune2011NativeItemTextField = -9,
	UIiMemorizeiPadJune2011NativeItemSearchBar = -10,
	
	UIiMemorizeiPadJune2011NativeItemPicker = -11,
	UIiMemorizeiPadJune2011NativeItemDatePicker = -12,
	
	UIiMemorizeiPadJune2011NativeItemInfoLight = -13,
	UIiMemorizeiPadJune2011NativeItemInfoDark = -14,
	
	UIiMemorizeiPadJune2011NativeItemDisclosure = -15,
	
	UIiMemorizeiPadJune2011NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all iMemorizeiPadJune2011 instances of
